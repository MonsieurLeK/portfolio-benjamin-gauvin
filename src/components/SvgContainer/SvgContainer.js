...
export default function SvgContainer(props) {
    ...
    return <div className={props.active ? styles.mainContainer : styles.displayNone} >
        ...
        <img className={styles.svg} alt='sass logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sass/sass-original.svg" />
        <svg viewBox="0 0 128 128" className={styles.svg} >
        ...
        <img className={styles.svg} alt='react logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg" />
        <img className={styles.svg} alt='three js logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original-wordmark.svg" />
        <img className={styles.svg} alt='node js logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg" />
        <img className={styles.svg} alt='npm logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/npm/npm-original-wordmark.svg" />
        <img className={styles.svg} alt='mongodb logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-original-wordmark.svg" />

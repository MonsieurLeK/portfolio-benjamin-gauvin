...
export default function SvgContainer(props) {
    ...
    return <div className={props.active ? styles.mainContainer : styles.displayNone} >
        <svg viewBox="0 0 128 128" className={`${styles.svg} logo`} >
        ...
        <img className={styles.svg} loading='lazy' alt='sass logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sass/sass-original.svg" />
        <svg viewBox="0 0 128 128" className={styles.svg} >
        ...
        <img className={styles.svg} loading='lazy' alt='react logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg" />
        <img className={styles.svg} loading='lazy' alt='three js logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original-wordmark.svg" />
        <img className={styles.svg} loading='lazy' alt='node js logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg" />
        <img className={styles.svg} loading='lazy' alt='npm logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/npm/npm-original-wordmark.svg" />
        <img className={styles.svg} loading='lazy' alt='mongodb logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-original-wordmark.svg" />
        <img className={styles.svg} loading='lazy' alt='mongodb logo' src={reduxLogo} />
    </div>
}